...
jmm_route.put('/orders/:id/change-fulfilment-site', authenticateUser, authorizePage('orderManagement', 'manage'), jmm_controller.handleChangeOrderFulfilmentSite);
...
jmm_route.get('/cash-deposits/payment-methods', authenticateUser, authorizeAnyPage(['addExpense', 'companyCashDeposits'], 'view'), jmm_controller.handleGetCashDepositPaymentMethods);
jmm_route.get('/cash-deposits/position', authenticateUser, authorizePage('addExpense', 'view'), jmm_controller.handleGetCompanyCashPosition);
jmm_route.post('/cash-deposits', authenticateUser, authorizePage('addExpense', 'manage'), jmm_controller.handleCreateCompanyCashDeposit);
jmm_route.get('/cash-deposits', authenticateUser, authorizeAnyPage(['addExpense', 'companyCashDeposits'], 'view'), jmm_controller.handleGetCompanyCashDeposits);
jmm_route.put('/cash-deposits/:id', authenticateUser, authorizePage('addExpense', 'manage'), jmm_controller.handleUpdateCompanyCashDeposit);
jmm_route.put('/cash-deposits/:id/review', authenticateUser, authorizePage('companyCashDeposits', 'manage'), jmm_controller.handleReviewCompanyCashDeposit);
...
jmm_route.get('/farm/clusters', authenticateUser, authorizeAnyPage(['farmBlocks', 'farmTrees', 'farmBlockDetails', 'analysisFarmProductionMap'], 'view'), jmm_controller.handleGetFarmClusters);
...
jmm_route.get('/farm/usher/summary', authenticateUser, authorizeAnyPage(['farmPriceManagement', 'farmUsherManage', 'farmUsherEntries', 'adminFinancialDashboard'], 'view'), jmm_controller.handleGetFarmUsherSummary);
jmm_route.put('/farm/usher/settings', authenticateUser, authorizeAnyPage(['farmPriceManagement', 'farmUsherManage'], 'manage'), jmm_controller.handleSaveFarmUsherSetting);
