    ...
    <div className="p-4 text-black">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-4">
        <div>
          ...
          <div className="text-xs text-gray-500">New outbound template/text messages are logged here. Older sent templates may appear only as delivery statuses if they were sent before chat logging was enabled.</div>
        </div>
